...
public class RegistroHuesped extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                RegistroHuesped frame = new RegistroHuesped("", "", 0.0, "");
     ...
     * Create the frame.
     */
    public RegistroHuesped(String fechaEntrada, String fechaSalida, Double valor, String modoPago) {
        ...
        txtCelular.setFont(new Font("Roboto", Font.PLAIN, 16));
        txtCelular.setBounds(560, 424, 285, 33);
        txtCelular.setColumns(10);
        txtCelular.setBackground(Color.WHITE);
        txtCelular.setBorder(javax.swing.BorderFactory.createEmptyBorder());
        contentPane.add(txtCelular);

        JLabel lblTitulo = new JLabel("REGISTRO DE HUÉSPED");
        ...
        btnGuardar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (txtNombre.getText() != null && txtApellido.getText() != null && txtFechaN.getDate() != null
                        && txtCelular.getText() != null && txtNumReserva.getText() != null) {
                    String nombre = txtNombre.getText();
                    String apellido = txtApellido.getText();
                    String fecha = new java.sql.Date(txtFechaN.getDate().getTime()).toLocalDate().toString();
                    String nacionalidad = (String) txtNacionalidad.getSelectedItem();
                    Integer celular = Integer.valueOf(txtCelular.getText());
                    Integer idReserva = Integer.valueOf(txtNumReserva.getText());
                    Integer returnedState = reservaController.guardar(idReserva, fechaEntrada, fechaSalida, valor, modoPago);
                    if (returnedState == 1) {
                        clienteController.guardar(nombre, apellido, fecha, nacionalidad, celular, idReserva);
                        ...
                        dispose();
                    } else if (returnedState == 10) {
                        JOptionPane.showMessageDialog(
                                null,
                                "Error: " + reservaController.getMessage() +
                                        "\nExplicación: El número de reserva " + idReserva + " ya existe.",
    ...
    private static JComboBox<String> getTxtNacionalidad() {
        ...
        txtNacionalidad.setModel(new DefaultComboBoxModel<>(new String[]{"Afganistán", "Alemania", "Arabia Saudita", "Argentina", "Australia", "Bélgica", "Bolivia", "Brasil", "Camboya", "Canadá", "Chile", "China", "Colombia", "Corea del Sur", "Corea del Norte", "Costa Rica", "Cuba", "Dinamarca", "Ecuador", "Egipto", "El Salvador", "Escocia", "España", "Estados Unidos", "Estonia", "Etiopía", "Filipinas", "Finlandia", "Francia", "Gales", "Grecia", "Guatemala", "Haití", "Holanda", "Honduras", "India", "Inglaterra", "Irak", "Irán", "Irlanda", "Israel", "Italia", "Japón", "Jordania", "Laos", "Letonia", "Malasia", "Marruecos", "México", "Nicaragua", "Noruega", "Nueva Zelanda", "Panamá", "Paraguay", "Perú", "Polonia", "Portugal", "Puerto Rico", "República Dominicana", "Rumanía", "Rusia", "Suecia", "Suiza", "Tailandia", "Taiwán", "Turquía", "Ucrania", "Uruguay", "Venezuela", "Vietnam"}));
